...
{
    /// <inheritdoc />
    public partial class Phase2CoreEngines : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "StateTransitionDefinitions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    EntityType = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StateTransitionDefinitions", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StateDefinitions_TenantId_EntityType_StateName",
                table: "StateDefinitions",
                columns: new[] { "TenantId", "EntityType", "StateName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StateTransitionDefinitions_TenantId_EntityType_FromState_TriggerName",
                table: "StateTransitionDefinitions",
                columns: new[] { "TenantId", "EntityType", "FromState", "TriggerName" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StateTransitionLogs_EntityType_EntityId",
                table: "StateTransitionLogs",
                columns: new[] { "EntityType", "EntityId" });

            migrationBuilder.CreateIndex(
                name: "IX_SystemConfigurations_TenantId_Key",
